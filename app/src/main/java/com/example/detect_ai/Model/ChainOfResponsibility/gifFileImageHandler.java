...
public class gifFileImageHandler implements ImageHandler {
    ...
    public gifFileImageHandler(MyCanvasView canvasView, Uri uri, ContentResolver cr, Context context){
