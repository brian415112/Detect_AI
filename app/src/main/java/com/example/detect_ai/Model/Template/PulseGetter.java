...
public class PulseGetter extends MeasureDataGetter{

    public PulseGetter(Activity activity, CountDownTimer countDownTimer) {
        ...
        call.enqueue(new Callback() {
            ...
            public void onFailure(@NotNull Call call, @NotNull IOException e) {
                ...
                if (e instanceof SocketTimeoutException) {
                    //判斷超時異常
                    Log.i("Failure_Pulse", e.getMessage());
                }
