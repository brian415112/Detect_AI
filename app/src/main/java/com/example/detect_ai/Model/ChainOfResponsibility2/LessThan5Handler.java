...
public class LessThan5Handler implements WordCountHandler {
    ...
    public void process(Context context, int word_count) {
        if(word_count < 5 && word_count > 0){
            Toast.makeText(context,"Disease Description cannot be less than 5 words.", Toast.LENGTH_SHORT).show();
