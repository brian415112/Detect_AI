...
public class pngFileImageHandler implements ImageHandler {
    ...
    public pngFileImageHandler(MyCanvasView canvasView, Uri uri, ContentResolver cr, Context context){
