...
public class bmpFileImageHandler implements ImageHandler {
    ...
    public bmpFileImageHandler(MyCanvasView canvasView, Uri uri, ContentResolver cr, Context context){
